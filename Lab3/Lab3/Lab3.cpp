...
void myDisplay()
{
	...
	glLoadIdentity();
	gluLookAt(3*cos(angle), 3*sqrt(2)/2, 3*sin(angle), 0, 2, 0, 0, 1, 0);
    ...
    glPushMatrix();
        ...
        //glRotatef(asin(-R/(y+y2-g))*cos(mvAngle)/PI*180, 0, 0, 1);
...
int main(int argc, char* argv[])
{
    ...
    shape3.CreateShape3(nSegment, y4, z4, x4, y5, x5);
